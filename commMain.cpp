...
int main() {
    ...
    // char message[] = {0xFF, 0xFF, 0x02, 0x01, 0x01, 0x01, 0x01, 0x00, 0x01, 0x01, 0x01, 0x01, 0x01};
    char message[] = {0xFF, 0xFF, 0x04, 0x1A, 0x04, 0x1A, 0x04, 0xD6, 0x06, 0xD6, 0x06, 0x01, 0x01};
    c.sendData(message, 13);
    time = millis();
